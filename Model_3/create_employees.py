...
employees = [
    ...
    Employee(name="David", employment_rate=0.4, early_late_preference=1, spread=2, unavailable_dates=[date(2025, 3, 19)]),
    ...
    Employee(name="Mona", employment_rate=0.7, early_late_preference=7, spread=4, unavailable_dates=[date(2025, 3, 23)]),
